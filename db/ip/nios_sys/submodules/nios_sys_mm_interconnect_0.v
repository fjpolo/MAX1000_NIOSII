...
module nios_sys_mm_interconnect_0 (
	...
	wire  [92:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> pll_pll_slave_agent:cp_data
	...
	wire  [93:0] pio_lis3dh_s1_agent_rf_source_data;                                         // pio_lis3dh_s1_agent:rf_source_data -> pio_lis3dh_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] pio_lis3dh_s1_agent_rsp_fifo_out_data;                                      // pio_lis3dh_s1_agent_rsp_fifo:out_data -> pio_lis3dh_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                      // cmd_mux_004:src_valid -> pio_lis3dh_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> pio_lis3dh_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                      // pio_lis3dh_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> pio_lis3dh_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                              // cmd_mux_004:src_startofpacket -> pio_lis3dh_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                // cmd_mux_004:src_endofpacket -> pio_lis3dh_s1_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> pio_leds_s1_agent:cp_data
	...
	wire  [93:0] spi_lis3dh_spi_control_port_agent_rf_source_data;                           // spi_lis3dh_spi_control_port_agent:rf_source_data -> spi_lis3dh_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [93:0] spi_lis3dh_spi_control_port_agent_rsp_fifo_out_data;                        // spi_lis3dh_spi_control_port_agent_rsp_fifo:out_data -> spi_lis3dh_spi_control_port_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                      // cmd_mux_006:src_valid -> spi_lis3dh_spi_control_port_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> spi_lis3dh_spi_control_port_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                      // spi_lis3dh_spi_control_port_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> spi_lis3dh_spi_control_port_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                              // cmd_mux_006:src_startofpacket -> spi_lis3dh_spi_control_port_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                // cmd_mux_006:src_endofpacket -> spi_lis3dh_spi_control_port_agent:cp_endofpacket
	...
	wire  [92:0] pll_pll_slave_agent_rp_data;                                                // pll_pll_slave_agent:rp_data -> router_004:sink_data
	...
	wire         pio_lis3dh_s1_agent_rp_valid;                                               // pio_lis3dh_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] pio_lis3dh_s1_agent_rp_data;                                                // pio_lis3dh_s1_agent:rp_data -> router_006:sink_data
	wire         pio_lis3dh_s1_agent_rp_ready;                                               // router_006:sink_ready -> pio_lis3dh_s1_agent:rp_ready
	wire         pio_lis3dh_s1_agent_rp_startofpacket;                                       // pio_lis3dh_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pio_lis3dh_s1_agent_rp_endofpacket;                                         // pio_lis3dh_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [92:0] pio_leds_s1_agent_rp_data;                                                  // pio_leds_s1_agent:rp_data -> router_007:sink_data
	...
	wire         spi_lis3dh_spi_control_port_agent_rp_valid;                                 // spi_lis3dh_spi_control_port_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] spi_lis3dh_spi_control_port_agent_rp_data;                                  // spi_lis3dh_spi_control_port_agent:rp_data -> router_008:sink_data
	wire         spi_lis3dh_spi_control_port_agent_rp_ready;                                 // router_008:sink_ready -> spi_lis3dh_spi_control_port_agent:rp_ready
	wire         spi_lis3dh_spi_control_port_agent_rp_startofpacket;                         // spi_lis3dh_spi_control_port_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         spi_lis3dh_spi_control_port_agent_rp_endofpacket;                           // spi_lis3dh_spi_control_port_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         pio_lis3dh_s1_agent_rdata_fifo_src_valid;                                   // pio_lis3dh_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pio_lis3dh_s1_agent_rdata_fifo_src_data;                                    // pio_lis3dh_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pio_lis3dh_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_004:in_0_ready -> pio_lis3dh_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                          // avalon_st_adapter_004:out_0_valid -> pio_lis3dh_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                           // avalon_st_adapter_004:out_0_data -> pio_lis3dh_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                          // pio_lis3dh_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                          // avalon_st_adapter_004:out_0_error -> pio_lis3dh_s1_agent:rdata_fifo_sink_error
	...
	wire         spi_lis3dh_spi_control_port_agent_rdata_fifo_src_valid;                     // spi_lis3dh_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] spi_lis3dh_spi_control_port_agent_rdata_fifo_src_data;                      // spi_lis3dh_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         spi_lis3dh_spi_control_port_agent_rdata_fifo_src_ready;                     // avalon_st_adapter_006:in_0_ready -> spi_lis3dh_spi_control_port_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                          // avalon_st_adapter_006:out_0_valid -> spi_lis3dh_spi_control_port_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                           // avalon_st_adapter_006:out_0_data -> spi_lis3dh_spi_control_port_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                          // spi_lis3dh_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                          // avalon_st_adapter_006:out_0_error -> spi_lis3dh_spi_control_port_agent:rdata_fifo_sink_error
	...
	nios_sys_mm_interconnect_0_router_003 router_005 (
	...
	nios_sys_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
